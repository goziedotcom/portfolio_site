...
class OtherProjectCard extends StatelessComponent {
  ...
  const OtherProjectCard({required this.project, required this.index, Key? key})
    : super(key: key);
  ...
  Component build(BuildContext context) {
    return Card(
      hoverEffect:
          CardHoverEffect.subtle, // Subtle hover for secondary projects
      additionalClasses:
          'group overflow-hidden animate-fade-in-up transition-all duration-300',
