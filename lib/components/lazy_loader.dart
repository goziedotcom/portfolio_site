...
class _LazyComponentState extends State<LazyComponent> {
    ...
    return StreamBuilder<Component>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return component.placeholder ?? _buildDefaultLoader();
        }
      },
    );
  }
  ...
  Component _buildDefaultLoader() {
    ...
    return div(classes: containerClasses, [
        ...
        [
              ...
              div(
                ...
                styles: Styles(
                  raw: {
                    ...
                    'mask':
                        'radial-gradient(circle at center, transparent 6px, black 8px)',
                    '-webkit-mask':
                        'radial-gradient(circle at center, transparent 6px, black 8px)',
                  },
                ),
          ...
          div(
            classes: '''
              ...
              ''',
            styles: Styles(
              raw: {'box-shadow': '0 0 12px hsl(var(--primary) / 0.6)'},
            ),
            [],
          ),
      ...
      // Progress dots
      div(classes: 'flex space-x-2 mt-4', [
        ...List.generate(
          3,
          (index) => div(
            classes: '''
              ...
              ''',
            styles: Styles(raw: {'animation-delay': '${index * 0.2}s'}),
            [],
          ),
        ),
      ]),
