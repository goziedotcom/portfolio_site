    ...
    return footer(
      ...
      [
        div(classes: 'container mx-auto px-4 sm:px-6 lg:px-8', [
                ...
                [
                  ...
                  span(
                    ...
                    [
                      ...
                      span(
                        classes:
                            'inline-block hover:scale-110 transition-transform duration-300',
                        [.text('❤️')],
                      ),
                    ],
                  ),
          ...
          div(classes: 'mt-6 pt-4 border-t border-border/30', [
            div(classes: 'flex justify-center', [
              div(
                classes:
                    'w-12 h-0.5 bg-gradient-primary rounded-full opacity-50',
                [],
              ),
            ]),
          ]),
