...
class ContactSection extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return section(id: 'contact', classes: 'py-20 relative overflow-hidden', [
      ...
      div(classes: 'container mx-auto px-4 sm:px-6 lg:px-8 relative z-10', [
        ...
        // Main Content Grid
        div(classes: 'grid lg:grid-cols-2 gap-12 items-center', [
  ...
  Component _buildBackgroundDecorations() {
    return div(classes: 'absolute inset-0', [
      // Top-right floating orb
      div(
        classes:
            'absolute top-20 right-20 w-64 h-64 bg-primary/10 rounded-full blur-3xl',
        [],
      ),
      // Bottom-left floating orb
      div(
        classes:
            'absolute bottom-20 left-20 w-64 h-64 bg-accent/10 rounded-full blur-3xl',
        [],
      ),
    ]);
  }
  ...
  Component _buildSectionHeader() {
    return div(classes: 'text-center mb-14', [
      h2(classes: 'text-3xl md:text-4xl font-bold font-display mb-4', [
        .text("Let's Work "),
        span(classes: 'gradient-text', [.text('Together')]),
      ]),
      p(classes: 'text-xl text-muted-foreground max-w-3xl mx-auto', [
        .text(
          "Ready to transform your app idea into reality? Let's discuss your project!",
        ),
      ]),
    ]);
  }
  ...
  Component _buildContactInfo() {
    return div(classes: 'space-y-8 animate-bounce-in', [
      // Contact Methods
      ...
      div(classes: 'pt-8', [
        h3(classes: 'font-semibold text-lg mb-4 flex items-center gap-2', [
          .text('Why Choose Me?'),
        ]),
  ...
  Component _buildContactItem({
    ...
    return div(classes: 'flex items-center gap-4 group', [
      // Icon container
      div(
        classes:
      ...
      // Text content
      div([
        h3(classes: 'font-semibold text-lg', [.text(title)]),
        p(classes: 'text-muted-foreground', [.text(description)]),
      ]),
    ]);
  }

  Component _buildBenefitItem(String benefit) {
    return li(classes: 'flex items-center gap-3', [
      // Purple bullet point
      div(classes: 'w-2 h-2 rounded-full bg-primary flex-shrink-0', []),
      // Benefit text
      span(classes: 'text-muted-foreground', [.text(benefit)]),
    ]);
  }
}
  ...
  Component build(BuildContext context) {
    return div(
      ...
      [
        Card(
          additionalClasses:
              'sticker relative overflow-hidden border-0 p-8 text-center rounded-xl',
          children: [
            CardContent(
              ...
              children: [
                ...
                div(
                  ...
                  [
                    TIcon(
                      lucideIcon: lucide.MessageCircle.new,
                      theme: IconTheme.monochrome,
                ...
                div(classes: 'space-y-4', [
                  h3(classes: 'text-2xl font-bold text-primary-foreground', [
                    .text('Ready to Get Started?'),
                  ]),
                  p(
                    classes:
                        'text-primary-foreground/90 max-w-sm mx-auto leading-relaxed',
                    [
                      .text(
