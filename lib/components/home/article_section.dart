...
class ArticlesSection extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return section(id: 'articles', classes: 'py-20', [
  ...
  Component _buildSectionHeader() {
    return div(classes: 'text-center mb-16', [
      h2(classes: 'text-3xl md:text-4xl font-bold font-display mb-4', [
        .text('Latest '),
        span(classes: 'gradient-text', [.text('Articles')]),
      ]),
      p(classes: 'text-xl text-muted-foreground max-w-2xl mx-auto', [
        .text(
          'Sharing knowledge and insights about software development and technology',
        ),
      ]),
    ]);
  }
