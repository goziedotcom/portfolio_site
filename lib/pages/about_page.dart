...
class AboutPage extends StatelessComponent {
  ...
  Component _buildHeader() {
    return div(classes: 'text-center mb-16', [
      h1(classes: 'text-4xl md:text-5xl font-bold font-display mb-4', [
        .text('About '),
        span(classes: 'gradient-text', [.text('Me')]),
      ]),
  ...
  Component _buildMainContent() {
    return div(classes: 'grid lg:grid-cols-2 gap-12 mb-16', [
      // Story Card
      Card(
          ...
          CardContent(
            ...
            children: [
              ...
              for (String paragraph
                  in SiteConfig.aboutPageContent.story.paragraphs)
                p(classes: 'text-muted-foreground leading-relaxed', [
                  .text(paragraph),
                ]),
            ],
          ),
  ...
  Component _buildSkillItem(String name, int level) {
    return div(classes: 'space-y-2', [
      div(classes: 'flex justify-between items-center', [
        ...
        span(classes: 'text-sm text-muted-foreground', [.text('${level}%')]),
      ]),
  ...
  Component _buildValues() {
    return div(classes: 'mb-16', [
      h2(classes: 'text-3xl font-bold font-display text-center mb-8', [
        .text('My '),
        span(classes: 'gradient-text', [.text('Values')]),
      ]),
      div(classes: 'grid md:grid-cols-3 gap-8', [
        // Iterating over strongly-typed Value objects
        for (
          int index = 0;
          index < SiteConfig.aboutPageContent.values.length;
          index++
        )
    ...
    return Card(
      ...
      children: [
        CardContent(
          ...
          children: [
            div(classes: 'flex justify-center mb-4 mt-4', [
              div(classes: 'p-3 rounded-lg bg-primary/10', [
                TIcon(
                  lucideIcon:
                      value.icon, // Accessing icon directly from Value object
            ...
            h3(
              ...
              [
                .text(value.title),
              ], // Accessing title directly from Value object
            ),
            p(
              classes: 'text-muted-foreground',
              [
                .text(value.description),
              ], // Accessing description directly from Value object
            ),
          ],
        ),
      ],
      ...
      children: [
        CardHeader(
          children: [
            CardTitle(
              additionalClasses:
                  'text-2xl gradient-text flex items-center pb-1',
              children: [
                TIcon(
    ...
    return div(classes: 'flex items-start space-x-4', [
      div(classes: 'flex-shrink-0', [
        Badge(
          ...
          ], // Accessing year directly from Achievement object
        ),
      ]),
      div(classes: 'flex-1', [
        h3(
          ...
          ], // Accessing title directly from Achievement object
        ),
        p(
          classes: 'text-muted-foreground',
          [
  ...
  Component _buildTechnologies() {
    return div(classes: 'mt-16', [
      h2(classes: 'text-3xl font-bold font-display text-center mb-8', [
        .text('Technologies I '),
        span(classes: 'gradient-text', [.text('Love')]),
      ]),
