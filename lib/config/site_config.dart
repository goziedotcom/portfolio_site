...
class SiteConfig {
  ...
  static const AboutContentData aboutPageContent = AboutContentData(
    ...
    story: StoryContent(
      title: "My Story",
      paragraphs: [
        "I started my development journey in 2020, shortly before lockdown, building web applications with React. In 2021 I moved into native Android development with Kotlin, learning the fundamentals of mobile development. Then, in early 2022, while taking courses on mobile app design, I discovered Flutter, and I was amazed by how I could build beautiful, native-feeling apps for multiple platforms from a single Dart codebase.",
